...
Man::Man(float x,float y,float z) {
    ...
    this->leg = create3DObject(GL_TRIANGLES, 48, legs, COLOR_GREEN, GL_FILL);
    ...
    this->body = create3DObject(GL_TRIANGLES, 36, bodies, COLOR_PINK, GL_FILL);
...
//            -2.0 , -0.61 , -0.3,
    ...
    this->eye = create3DObject(GL_TRIANGLES, 6, eyes, COLOR_PINK, GL_FILL);
